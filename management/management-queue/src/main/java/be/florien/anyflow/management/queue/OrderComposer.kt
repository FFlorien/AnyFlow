...
suspend fun FilterParam<*>.contains(song: SongInfo, queueRepository: QueueRepository): Boolean {
    return when (this.type) {
        ...
        TagFilterType.PLAYLIST_IS -> queueRepository.isPlaylistContainingSong(
            argument as Long,
            song.id
        )
