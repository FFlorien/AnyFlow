...
class LibraryPlaylistListViewModel @Inject constructor(
    ...
    override fun getPagingList(
        ...
        libraryListTagsRepository.getPlaylistFiltersPaging(filter, search)

    override fun isThisTypeOfFilter(filterParam: FilterParam<*>) =
        filterParam.type == TagFilterType.PLAYLIST_IS
    ...
    override suspend fun getFoundFilters(
        ...
        withContext(Dispatchers.Default) {
            libraryListTagsRepository.getPlaylistFilterList(filter, search)
        }
