...
class LibraryTagsListViewModel @Inject constructor(
    ...
    override fun getPagingList(
        filter: Filter?,
        search: String?
    ): Flow<PagingData<FilterItem>> = libraryListTagsRepository.getSongFiltersPaging(filter, search)
    ...
    override suspend fun getFoundFilters(
        ...
        withContext(Dispatchers.Default) {
            libraryListTagsRepository.getSongFilterList(filter, search)
        }
