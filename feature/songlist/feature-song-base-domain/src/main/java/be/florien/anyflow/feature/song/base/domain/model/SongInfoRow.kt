...
abstract class BaseSongInfoRow( //todo sealed
...
) : SongMultipleInfoRow(fieldType, actionType, index)
...
data class SongInfoMultipleContainerRow(
    ...
    override val index: Int,
    val subRows: List<BaseSongInfoRow>
) : SongMultipleInfoRow(fieldType, SongActionType.ExpandableTitle, index)
...
) : SongMultipleInfoRow(fieldType, actionType, index), SongDownload
