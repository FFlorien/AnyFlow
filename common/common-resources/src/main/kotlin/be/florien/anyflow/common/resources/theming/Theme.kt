...
fun AppTheme(
    ...
    val contrast = if (!LocalInspectionMode.current && isContrastAvailable()) {
        ...
        when (uiModeManager.contrast) {
            in 0.33f ..0.66f -> Contrast.Medium
            in 0.66f ..1f -> Contrast.High
    ...
    val colorScheme = when {
        !darkTheme && contrast == Contrast.Standard -> lightScheme
        !darkTheme && contrast == Contrast.Medium -> mediumContrastLightColorScheme
        !darkTheme -> highContrastLightColorScheme
        darkTheme && contrast == Contrast.Standard -> darkScheme
