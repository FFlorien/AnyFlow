...
class AmpacheApiDisconnected : AmpacheApi {
    ...
    override fun getSongs(action: String, add: String, auth: String, limit: Int, offset: Int): Observable<AmpacheSongList> =
            Observable.error(NoServerException())

    override fun getArtists(action: String, add: String, auth: String, limit: Int, offset: Int): Observable<AmpacheArtistList> =
            Observable.error(NoServerException())

    override fun getAlbums(action: String, add: String, auth: String, limit: Int, offset: Int): Observable<AmpacheAlbumList> =
            Observable.error(NoServerException())

    override fun getTags(action: String, add: String, auth: String, limit: Int, offset: Int): Observable<AmpacheTagList> =
            Observable.error(NoServerException())

    override fun getPlaylists(action: String, add: String, auth: String, limit: Int, offset: Int): Observable<AmpachePlayListList> =
            Observable.error(NoServerException())
