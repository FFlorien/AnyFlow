...
import be.florien.anyflow.feature.mediaList.ui.di.MediaListViewModelModule
...
@Subcomponent(
    modules = [
        // ViewModelModules
        MediaListViewModelModule::class,
...
interface ServerComponent : GlideModuleInjector {
    ...
    // Activities
    fun userConnectComponentBuilder(): AuthenticationViewModelComponent.Builder
